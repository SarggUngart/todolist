...
import {FilteredTasksType, todolistReducer, UpdateTodoListTitleType} from "./todolist-reducer";
...
test('correct todolist should change its name', () => {
  ...
  const action:UpdateTodoListTitleType = {
...
test('correct filter of todolist should be changed', () => {
  ...
  const action:FilteredTasksType = {
